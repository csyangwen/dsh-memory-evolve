    ...
    >
      ...
      >
        ...
        <div className={css.content}>
          ...
          {loading && slowScan
          && <div className={cx(css.status, css.loadingFloat)} role="status">{t('browser.loading')}</div>}
        ...
        <div className={css.footerBar}>
          ...
          <Button variant="outline" className={cx(css.footerAction)} disabled={parentInert} onClick={onClose}>{t('browser.cancel')}</Button>
          <Button
            variant="primary"
