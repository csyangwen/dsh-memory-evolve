 ...
 */
export function renderSnapshot(config, store, agent, counter, wsCoordStore = null, wsCoordMeta = null, wsCoordArchived = null) {
  const parts = []
...
export function apply(ctx, rawConfig = {}) {
  ...
  if (config.injectMemory) {
    ctx.effect(() => ctx.systemPrompt.context({
      ...
      text: (context) => renderSnapshot(getRuntime(), store, context.agent, counter, wsCoordStoreRef, wsCoordMetaRef, wsCoordArchivedRef !== null ? wsCoordArchivedRef() : null),
