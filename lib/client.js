  ...
  return /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("div", { className: "mt-panel", children: !initialized ? /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("div", { className: "bb-empty", children: t2("syncTab.loading") }) : /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)(import_jsx_runtime19.Fragment, { children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("label", { className: "me-field", children: [
      /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("span", { className: "me-field-label", children: [
        t2("syncTab.enabled"),
        /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("em", { className: "me-field-hint", children: t2("syncTab.enabled.hint") })
      ] }),
...
var zh = {
  ...
  "syncTab.enabled": "\u542F\u7528\u8BB0\u5FC6\u540C\u6B65\u6A21\u5757",
  "syncTab.enabled.hint": "\u6A21\u5757\u5F00\u5173\uFF1A\u8BA9\u300C\u8BB0\u5FC6\u540C\u6B65\u300DTab \u4E0E /memory_sync \u547D\u4EE4\u53EF\u7528\u3002**\u4E0D\u7B49\u4E8E\u672C\u9879\u76EE\u5F00\u59CB\u540C\u6B65**\u2014\u2014\u5177\u4F53\u9879\u76EE\u7531\u4E0B\u65B9\u300C\u672C\u9879\u76EE\u540C\u6B65\u300D\u5F00\u5173\u63A7\u5236\uFF08\u9ED8\u8BA4\u5173\uFF09",
  ...
  "panel.config.syncEnabled": "\u9879\u76EE\u8BB0\u5FC6\u540C\u6B65",
  "panel.config.syncEnabled.hint": "\u542F\u7528\u9879\u76EE\u8BB0\u5FC6\u8DE8\u8BBE\u5907\u5171\u4EAB\uFF08/memory_sync\uFF09\uFF1A\u628A\u672C\u9879\u76EE\u5173\u952E\u8BB0\u5FC6\uFF08KEY + \u9879\u76EE\u65E5\u5FD7 + \u5F52\u6863\uFF09\u7ECF Git \u5BF9\u8D26\u5230\u8FDC\u7AEF\u2014\u2014\u6A21\u5F0F A\uFF08\u9ED8\u8BA4\uFF0C\u96F6\u914D\u7F6E\uFF09\uFF1A\u590D\u7528\u4E3B\u4ED3\u5E93 remote\uFF0C\u8BB0\u5FC6\u5B58\u5728\u4E13\u5C5E\u5206\u652F dsh-shared/memory\uFF08\u4E0D\u6C61\u67D3\u4EE3\u7801 log\uFF09\uFF1B\u6A21\u5F0F B\uFF1A/memory_sync setup <url> \u6307\u5B9A\u79C1\u6709\u8BB0\u5FC6\u4ED3\u5E93\u3002\u5199\u8BB0\u5FC6\u7167\u5E38\u5B9E\u65F6\u843D\u76D8\uFF08\u5B8C\u5168\u4E0D\u78B0 Git\uFF09\uFF0C\u540C\u6B65\u662F\u6512\u4E00\u6279\u5408\u4E00\u6B21\uFF08/memory_sync sync\uFF09\uFF1B\u5408\u5E76\u51B2\u7A81\u6C38\u4E0D\u843D\u76D8\uFF0C\u7F55\u89C1\u53CC\u6539\u51B2\u7A81\u8FDB\u4EBA\u5DE5\u5904\u7406\uFF08/memory_sync conflict list\uFF09\u3002**\u72EC\u7ACB\u5B50\u6A21\u5757\uFF0C\u9ED8\u8BA4\u5173\u95ED**\u2014\u2014\u4E0D\u5F00\u7684\u9879\u76EE\u884C\u4E3A\u96F6\u53D8\u5316\uFF1Bpush \u6C38\u8FDC\u9700\u4F60\u663E\u5F0F\u89E6\u53D1\uFF08/memory_sync sync --push\uFF09",
...
var en = {
  ...
  "syncTab.enabled": "Enable memory sync module",
  "syncTab.enabled.hint": 'Module switch: makes this tab and /memory_sync available. **It does NOT start syncing any project** \u2014 each project is opted in by the "Project sync" switch below (off by default)',
  ...
  "panel.config.syncEnabled": "Project memory sync",
  "panel.config.syncEnabled.hint": "Enable cross-device project memory sharing (/memory_sync): sync this project's KEY + project log + archive to a remote via Git \u2014 mode A (default, zero config) reuses the main repo remote with memory on the dedicated dsh-shared/memory branch (no code-log pollution); mode B: /memory_sync setup <url> for a private memory repo. Writing memory stays real-time local (no Git touched); sync batches up (/memory_sync sync); merge conflicts never hit disk, rare both-side edits go to manual resolution (/memory_sync conflict list). **Independent module, off by default** \u2014 off projects behave byte-identical; push always requires your explicit trigger (/memory_sync sync --push)",
