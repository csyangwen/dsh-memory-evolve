  ...
  const runSuggestions = (op, indices) => {
    ...
    if (op === "approve") {
      ...
      for (const index of indices) {
        ...
        if (pick2 !== void 0 && pick2 !== entries?.[index - 1]?.target) overrides[String(index)] = pick2;
      }
...
var DICT = {
  zh: {
    ...
    "launch.injectCtxHint": "\u628A AGENTS \u89C4\u5219/\u957F\u671F\u8BB0\u5FC6/\u7528\u6237\u6863\u6848/\u672C\u9879\u76EE\u5173\u952E\u8BB0\u5FC6\uFF08\u6309\u5206\u652F\uFF09\u5E26\u7ED9 COI\uFF0C\u8BA9\u5B83\u4E86\u89E3\u9879\u76EE\u7EA6\u5B9A\uFF08\u5185\u5BB9\u4F1A\u53D1\u7ED9\u5916\u90E8 COI \u670D\u52A1\uFF0C\u6CE8\u610F\u9690\u79C1\uFF09",
    ...
    "config.defaultInjectHint": "\u65B0\u4EFB\u52A1\u9ED8\u8BA4\u628A DSH \u8BB0\u5FC6\uFF08AGENTS \u89C4\u5219/\u957F\u671F\u8BB0\u5FC6/\u7528\u6237\u6863\u6848/\u672C\u9879\u76EE\u5173\u952E\u8BB0\u5FC6\u6309\u5206\u652F\uFF09\u5E26\u7ED9 COI\uFF1B\u6BCF\u6B21\u53D1\u8D77\u65F6\u53EF\u5355\u72EC\u8986\u76D6\u3002\u9ED8\u8BA4\u5173\uFF08\u5185\u5BB9\u4F1A\u53D1\u7ED9\u5916\u90E8 COI \u670D\u52A1\uFF09",
    "config.save": "\u4FDD\u5B58",
    "config.saved": "\u5DF2\u4FDD\u5B58",
    "scope.temporary": "\u4E34\u65F6",
    "scope.session": "\u4F1A\u8BDD",
  ...
  en: {
    ...
    "launch.injectCtxHint": "Hand AGENTS rules / long-term memory / user profile / this project's key facts (branch-filtered) to the COI so it knows the project conventions (content is sent to external COI services \u2014 mind privacy)",
    ...
    "config.defaultInjectHint": "New tasks carry the DSH memory (AGENTS rules / long-term memory / user profile / this project's key facts, branch-filtered) to the COI; overridable per dispatch. Off by default (content is sent to external COI services)",
    "config.save": "Save",
    "config.saved": "Saved",
    ...
    /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "coi-card", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "coi-form-grid", children: [
        /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("label", { className: "coi-field", children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("select", { className: "coi-select", value: adapterId, onChange: (e) => setAdapterId(e.target.value), children: [
        ...
        scope !== "temporary" && /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("label", { className: "coi-field", children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("select", { className: "coi-select", value: sessionId, onChange: (e) => setSessionId(e.target.value), children: [
            ...
            sessions.map((s) => /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("option", { value: s.id, children: [
              s.id,
              "\uFF08",
              s.adapterId,
...
function ScratchView(props) {
  ...
  const save = (0, import_react6.useCallback)(async () => {
    ...
    try {
      ...
      setNotice({ kind: "ok", text: DICT2.zh.saved });
    } catch (err) {
      setNotice({ kind: "error", text: pick(DICT2.zh.saveFailed, DICT2.en.saveFailed).replace("{message}", errText2(err)) });
    } finally {
      setSaving(false);
    }
  }, [content, path]);
  (0, import_react6.useEffect)(() => {
    const onKeyDown = (event) => {
      if ((event.metaKey || event.ctrlKey) && event.key.toLowerCase() === "s" && textareaRef.current === event.target) {
  ...
  const openFile = async () => {
    ...
    try {
      await revealScratch();
      setNotice({ kind: "ok", text: pick(DICT2.zh.opened, DICT2.en.opened) });
    } catch (err) {
      setNotice({ kind: "error", text: pick(DICT2.zh.openFailed, DICT2.en.openFailed).replace("{message}", errText2(err)) });
    }
  };
  const savedLabel = mtime === null ? pick(DICT2.zh.neverSaved, DICT2.en.neverSaved) : pick(DICT2.zh.savedAt, DICT2.en.savedAt).replace("{time}", formatTime3(mtime));
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "sp-root", children: [
    /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "sp-head", children: [
      /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("span", { className: "sp-path", title: path ?? "", children: [
        "\u{1F4DD} ",
        path ?? ""
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: "sp-saved-at", children: savedLabel })
    ] }),
    ...
    loaded && /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(import_jsx_runtime6.Fragment, { children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "sp-toolbar", children: [
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: "sp-dirty", children: dirty ? pick(DICT2.zh.dirty, DICT2.en.dirty) : "" }),
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: "sp-hint", children: pick(DICT2.zh.hintSave, DICT2.en.hintSave) }),
        notice !== null && /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: `sp-notice sp-notice-${notice.kind}`, children: notice.text }),
        ...
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
          "button",
          {
            ...
            onClick: () => void save(),
            children: saving ? pick(DICT2.zh.saving, DICT2.en.saving) : pick(DICT2.zh.save, DICT2.en.save)
          }
        )
      ] })
    ] }),
...
function apply(ctx) {
  ...
  void fetch("/memory-evolve/api/config").then((res) => res.ok ? res.json() : Promise.reject(new Error(`HTTP ${res.status}`))).then((data) => {
    if (!scratchCancelled && disposeScratchTab === void 0) {
