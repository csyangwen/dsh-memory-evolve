...
function MemoryTabView(props) {
  ...
  const [branch, setBranch] = (0, import_react3.useState)(null);
  const [branches, setBranches] = (0, import_react3.useState)([]);
  const [view, setView] = (0, import_react3.useState)("pretty");
  const [query, setQuery] = (0, import_react3.useState)("");
  const [activeKey, setActiveKey] = (0, import_react3.useState)(persistedFileKey);
  const [keyDraft, setKeyDraft] = (0, import_react3.useState)("");
  const [keySaving, setKeySaving] = (0, import_react3.useState)(false);
  const [keyScope, setKeyScope] = (0, import_react3.useState)([]);
  const [scopeEdit, setScopeEdit] = (0, import_react3.useState)(null);
  const [scopeDraft, setScopeDraft] = (0, import_react3.useState)([]);
  const [scopeSaving, setScopeSaving] = (0, import_react3.useState)(false);
  const [deleting, setDeleting] = (0, import_react3.useState)(false);
  const [feature, setFeature] = (0, import_react3.useState)(persistedFeature);
  const [badge, setBadge] = (0, import_react3.useState)({ suggestions: 0, skills: 0 });
  const pollBadge = (0, import_react3.useCallback)(() => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "mt-panel", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(
        "button",
        {
          ...
          children: [
            ...
            badge.skills > 0 && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "mt-feature-count", children: badge.skills })
          ]
        }
      ),
    ...
    feature !== null ? feature === "skill-browser" ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(SkillsBrowser, { t }) : /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
      MemoryQueueView,
      {
        t,
        feature,
...
var zh = {
  ...
  "preview": "\u9884\u89C8",
  "memoryTab.label": "\u8BB0\u5FC6\u6280\u80FD",
  "memoryTab.label.pending": "\u{1F534} \u8BB0\u5FC6\u6280\u80FD ({count})",
...
var en = {
  ...
  "preview": "Preview",
  "memoryTab.label": "Memory & Skills",
  "memoryTab.label.pending": "\u{1F534} Memory & Skills ({count})",
