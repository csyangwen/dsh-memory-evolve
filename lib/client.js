    ...
    if (indices !== void 0) {
      ...
      if (op === "approve") {
        ...
        for (const index of indices) {
          ...
          if (pick !== void 0 && pick !== entries?.[index - 1]?.target) overrides[String(index)] = pick;
        }
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "me-panel", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "me-todo-filters", children: [
      ...
      (target === "all" || target === "past") && /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("label", { className: "me-todo-filter me-todo-filter-check", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { children: t("todo.showExpired") })
      ] })
    ] }),
    items === null ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { className: "me-muted", children: t("panel.loading") }) : visible.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("p", { className: "me-empty", children: [
      t("todo.empty"),
      ...
      group.items.map((item) => {
        ...
        return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("li", { className: `me-item me-todo-item${done ? " me-todo-item--done" : ""}`, children: [
          /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "me-item-head", children: [
            target === "all" && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "me-badge me-badge-target", children: item.past === true ? t("todo.track.past") : t(`todo.track.${item.target}`) }),
        ...
        !activeRow.available ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("p", { className: "mt-muted", children: t("memoryTab.noCwd") }) : !activeRow.exists ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("pre", { className: "mt-content", children: t("memoryTab.empty") }) : activeEntries === null ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("pre", { className: "mt-content", children: activeRow.content }) : /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "mt-entries", children: [...activeEntries].reverse().map((entry, index) => /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "mt-entry", children: [
          ...
          editEntryRaw === entry.raw ? /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "mt-entry-edit", children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "mt-entry-edit-row", children: [
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "mt-entry-edit-hint", children: t("memoryTab.editHint") }),
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
                "button",
                {
                  type: "button",
              ...
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("button", { type: "button", className: "mt-btn", disabled: editSaving, onClick: () => setEditEntryRaw(null), children: t("memoryTab.cancel") })
            ] })
...
var zh = {
  ...
  "panel.config.searchDocsEnabled": "\u672C\u5730\u6587\u6863\u641C\u7D22\u5DE5\u5177",
  "panel.config.searchDocsEnabled.hint": "\u542F\u7528 memory_evolve_search_local_docs\uFF1A\u8BA9\u6A21\u578B\u80FD\u5728\u672C\u673A\u6240\u6709\u78C1\u76D8/\u76EE\u5F55\u4E2D\u6309\u6587\u4EF6\u540D\u67E5\u627E\u6587\u6863\uFF08md/docx/pdf\u2026\uFF0C\u53EA\u5339\u914D\u6587\u4EF6\u540D\u4E0D\u8BFB\u5185\u5BB9\uFF09\u3002\u9ED8\u8BA4\u5173\u95ED\uFF1B\u5173\u95ED\u65F6\u5DE5\u5177\u5BF9\u6A21\u578B\u5B8C\u5168\u4E0D\u53EF\u89C1",
...
var en = {
  ...
  "panel.config.searchDocsEnabled": "Local document search tool",
  "panel.config.searchDocsEnabled.hint": "Enable memory_evolve_search_local_docs: lets the model find documents by file name across all local disks/directories (md/docx/pdf\u2026, name matching only, never reads contents). Off by default; when off the tool is completely invisible to the model",
