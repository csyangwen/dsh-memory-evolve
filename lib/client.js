...
function VersionTabView(props) {
  ...
  const [updating, setUpdating] = (0, import_react7.useState)(false);
...
function ModelsTabView(props) {
  ...
  const [showReasoning, setShowReasoning] = (0, import_react9.useState)(true);
  const [expanded, setExpanded] = (0, import_react9.useState)(void 0);
  const [saving, setSaving] = (0, import_react9.useState)(/* @__PURE__ */ new Set());
  ...
  const update = (0, import_react9.useCallback)(async (provider, model, patch) => {
  ...
  const applyLocal = (0, import_react9.useCallback)((provider, model, mutate) => {
    setSnapshot((current) => {
  ...
  const toggleEnabled = (0, import_react9.useCallback)((provider, model) => {
  ...
  const saveNote = (0, import_react9.useCallback)((provider, model, note) => {
  ...
  const saveReasoning = (0, import_react9.useCallback)((provider, model, thinking, recommended, enabledIds, custom) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { className: "mt-panel", children: [
...
function RowView(props) {
  ...
  const [levelDraft, setLevelDraft] = (0, import_react9.useState)(
    () => new Set((row.reasoning?.levels ?? []).filter((l) => l.enabled).map((l) => l.id))
  );
  const [customDraft, setCustomDraft] = (0, import_react9.useState)(
    () => (row.reasoning?.levels ?? []).filter((l) => l.custom).map((l) => ({ id: l.id, name: l.name }))
  );
  const [newId, setNewId] = (0, import_react9.useState)("");
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("tr", { className: row.enabled ? "mt-models-row" : "mt-models-row mt-models-row-muted", children: [
    /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("td", { className: "mt-models-cell mt-models-col-enable", children: /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(
      "input",
      {
        type: "checkbox",
        checked: row.enabled,
    ...
    showReasoning ? /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("td", { className: "mt-models-cell mt-models-col-reasoning", children: !row.thinking ? /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("span", { className: "mt-models-tag mt-models-tag-off", children: t2("modelsTab.thinkingOff") }) : levels.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("span", { className: "mt-models-muted-cell", children: "\u2014" }) : /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)(import_jsx_runtime10.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { className: "mt-models-levels", children: [
        ...
        usable.length > 4 ? /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("span", { className: "mt-models-level-more", children: [
          "+",
          usable.length - 4
        ] }) : null
      ] }),
    ...
    expanded && levels.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("td", { className: "mt-models-expanded", colSpan: showReasoning ? 6 : 5, children: /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { className: "mt-models-editor", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("div", { className: "mt-models-editor-levels", children: levels.map((l) => /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("label", { className: "mt-models-editor-level", children: [
        /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(
          "input",
          {
            type: "checkbox",
      ...
      /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { className: "mt-models-editor-add", children: [
        /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(
          "input",
          {
            className: "mt-search",
      ...
      /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { className: "mt-models-editor-actions", children: [
        /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(
          "button",
          {
            type: "button",
...
function FeatureSwitchRow({ label, hint, checked, onChange }) {
  return /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("label", { className: "me-field", children: [
    /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("span", { className: "me-field-label", children: [
      label,
      /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("em", { className: "me-field-hint", children: hint })
    ] }),
...
function NoticeLine(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("div", { className: `coi-notice coi-notice-${props.notice.kind}`, children: props.notice.text });
}
...
function TasksPane({ dsSessionId }) {
  ...
  const [refTasks, setRefTasks] = (0, import_react11.useState)([]);
  const [tasks, setTasks] = (0, import_react11.useState)(null);
  const [error, setError] = (0, import_react11.useState)(null);
  const [notice, setNotice] = (0, import_react11.useState)(null);
  const [adapterId, setAdapterId] = (0, import_react11.useState)("kimi");
  const [prompt, setPrompt] = (0, import_react11.useState)("");
  const [scope, setScope] = (0, import_react11.useState)("session");
  const [sessionId, setSessionId] = (0, import_react11.useState)("");
  const [templateId, setTemplateId] = (0, import_react11.useState)("");
  const [refTaskId, setRefTaskId] = (0, import_react11.useState)("");
  const [launching, setLaunching] = (0, import_react11.useState)(false);
  const [injectTracks, setInjectTracks] = (0, import_react11.useState)([]);
  const [ctxText, setCtxText] = (0, import_react11.useState)("");
  const [launchOpen, setLaunchOpen] = (0, import_react11.useState)(false);
  const [selectedId, setSelectedId] = (0, import_react11.useState)(null);
  const [detail, setDetail] = (0, import_react11.useState)(null);
  const [log, setLog] = (0, import_react11.useState)("");
  const [logError, setLogError] = (0, import_react11.useState)(null);
  const [copied, setCopied] = (0, import_react11.useState)(false);
  const [fullLog, setFullLog] = (0, import_react11.useState)(false);
  const [fullPrompt, setFullPrompt] = (0, import_react11.useState)(false);
  const [searchQ, setSearchQ] = (0, import_react11.useState)("");
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { className: "coi-pane coi-tasks", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("div", { className: "coi-task-toolbar", children: /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
      "input",
      {
        className: "coi-input",
        ...
        tasks?.map((task) => {
          ...
          return /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)(
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("span", { className: `coi-task-status ${meta.cls}`, title: meta.label, children: meta.icon }),
    ...
    fullPrompt && detail !== null && /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("div", { className: "coi-modal", onClick: () => setFullPrompt(false), children: /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { className: "coi-modal-box", onClick: (e) => e.stopPropagation(), children: [
      /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { className: "coi-modal-head", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("button", { type: "button", className: "coi-btn coi-btn-mini", onClick: () => setFullPrompt(false), children: "\u2715" })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("pre", { className: "coi-log coi-log-full coi-prompt-view-full", children: detail.prompt })
    ] }) }),
...
function SessionsPane({ dsSessionId }) {
  ...
  const [error, setError] = (0, import_react11.useState)(null);
  const [notice, setNotice] = (0, import_react11.useState)(null);
  const [scopeFilter, setScopeFilter] = (0, import_react11.useState)("");
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { className: "coi-pane", children: [
    ...
    sessions?.map((s) => /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { className: "coi-row", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { className: "coi-row-line", children: [
        editId === s.id ? /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)(import_jsx_runtime12.Fragment, { children: [
          /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
            "input",
            {
...
function AdaptersPane() {
  ...
  const [error, setError] = (0, import_react11.useState)(null);
  const [notice, setNotice] = (0, import_react11.useState)(null);
  const [guideOpen, setGuideOpen] = (0, import_react11.useState)(null);
  const [skillEditId, setSkillEditId] = (0, import_react11.useState)(null);
  const [skillEditName, setSkillEditName] = (0, import_react11.useState)("");
  const [skillContent, setSkillContent] = (0, import_react11.useState)("");
  const [skillSaving, setSkillSaving] = (0, import_react11.useState)(false);
  const [skillError, setSkillError] = (0, import_react11.useState)(null);
  const [useCaseEditId, setUseCaseEditId] = (0, import_react11.useState)(null);
  const [useCaseDraft, setUseCaseDraft] = (0, import_react11.useState)("");
  const [fId, setFId] = (0, import_react11.useState)("");
  const [fName, setFName] = (0, import_react11.useState)("");
  const [fType, setFType] = (0, import_react11.useState)("ai-cli");
  const [fBinary, setFBinary] = (0, import_react11.useState)("");
  const [fArgs, setFArgs] = (0, import_react11.useState)("");
  const [fSkill, setFSkill] = (0, import_react11.useState)("");
  const [fUseCase, setFUseCase] = (0, import_react11.useState)("");
  const [fSkillContent, setFSkillContent] = (0, import_react11.useState)("");
  const [fResumeKind, setFResumeKind] = (0, import_react11.useState)("flag");
  const [fResumeFlag, setFResumeFlag] = (0, import_react11.useState)("");
  const [fResumeArg, setFResumeArg] = (0, import_react11.useState)("");
  const [fResumeArgs, setFResumeArgs] = (0, import_react11.useState)("");
  const [fContinueFlag, setFContinueFlag] = (0, import_react11.useState)("");
  const [fExtractSource, setFExtractSource] = (0, import_react11.useState)("none");
  const [fExtractRegex, setFExtractRegex] = (0, import_react11.useState)("");
  const [adding, setAdding] = (0, import_react11.useState)(false);
  const load = (0, import_react11.useCallback)(async () => {
    try {
        ...
        fType === "ai-cli" && /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)(import_jsx_runtime12.Fragment, { children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("label", { className: "coi-field", children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("select", { className: "coi-select", value: fExtractSource, onChange: (e) => setFExtractSource(e.target.value), children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("option", { value: "stderr", children: "stderr" }),
              /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("option", { value: "any", children: "any" })
            ] })
          ] }),
...
function TemplatesPane() {
  ...
  const [fId, setFId] = (0, import_react11.useState)("");
  const [fName, setFName] = (0, import_react11.useState)("");
  const [fPrompt, setFPrompt] = (0, import_react11.useState)("");
  const [fAdapterId, setFAdapterId] = (0, import_react11.useState)("");
  const [adding, setAdding] = (0, import_react11.useState)(false);
  const load = (0, import_react11.useCallback)(async () => {
    try {
...
function ConfigPane() {
  ...
  const [error, setError] = (0, import_react11.useState)(null);
  const [notice, setNotice] = (0, import_react11.useState)(null);
  const [notify, setNotify] = (0, import_react11.useState)("");
  const [retention, setRetention] = (0, import_react11.useState)("");
  const [timeoutH, setTimeoutH] = (0, import_react11.useState)("");
  const [timeoutM, setTimeoutM] = (0, import_react11.useState)("");
...
function AliasButton(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("span", { className: "me-alias-wrap", children: [
    ...
    open && /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("span", { className: "me-alias-editor", children: [
      /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(
        "input",
        {
      ...
      /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("button", { type: "button", className: "me-copy-session-id", disabled: saving, onClick: () => void save(), children: props.t("header.setAlias.save") }),
      /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("button", { type: "button", className: "me-copy-session-id", disabled: saving || name === "", onClick: () => void clear(), children: props.t("header.setAlias.clear") }),
      notice !== null && /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("span", { className: "me-alias-notice", children: notice })
    ] })
  ] });
}
...
function HeaderActions(props) {
  return /* @__PURE__ */ (0, import_jsx_runtime15.jsxs)(import_jsx_runtime15.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(CopySessionIdButton, { ...props }),
    /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(AliasButton, { ...props })
  ] });
}
...
function WsCoordSettings({ t: t2 }) {
  ...
  if (config === null) return /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("div", { className: "bb-empty", children: t2("broadcast.loading") });
  const on = (k) => config[k] === true;
  return /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("div", { className: "bb-settings", children: [
    /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("div", { className: "bb-settings-title", children: t2("broadcast.settings.wsCoord.title") }),
    /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("p", { className: "bb-settings-desc", children: t2("broadcast.settings.wsCoord.desc") }),
    /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("label", { className: "me-field", children: [
      /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("span", { className: "me-field-label", children: [
        t2("broadcast.settings.wsCoord.enabled"),
        /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("em", { className: "me-field-hint", children: t2("broadcast.settings.wsCoord.enabled.hint") })
      ] }),
    ...
    on("wsCoordEnabled") && /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)(import_jsx_runtime16.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("label", { className: "me-field me-field-sub", children: [
        /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("span", { className: "me-field-label", children: [
          t2("broadcast.settings.wsCoord.snapshot"),
          /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("em", { className: "me-field-hint", children: t2("broadcast.settings.wsCoord.snapshot.hint") })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(
          "input",
          {
      ...
      /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("label", { className: "me-field me-field-sub", children: [
        /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("span", { className: "me-field-label", children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("em", { className: "me-field-hint", children: t2("broadcast.settings.wsCoord.enforce.hint") })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(
          "input",
          {
    ...
    error !== null && /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("div", { className: "bb-error", children: error })
  ] });
}
function BroadcastView(props) {
  const { t: t2, sessionId } = props;
  const [view, setView] = (0, import_react14.useState)("messages");
  const [messages, setMessages] = (0, import_react14.useState)(null);
  const [rooms, setRooms] = (0, import_react14.useState)(null);
  const [roomMap, setRoomMap] = (0, import_react14.useState)(/* @__PURE__ */ new Map());
  const [aliases, setAliases] = (0, import_react14.useState)({});
  const [filter, setFilter] = (0, import_react14.useState)("unread");
  const [query, setQuery] = (0, import_react14.useState)("");
  const [page, setPage] = (0, import_react14.useState)(1);
  const [roomMsgFilter, setRoomMsgFilter] = (0, import_react14.useState)("unread");
  const [roomMsgQuery, setRoomMsgQuery] = (0, import_react14.useState)("");
  const [roomMsgPage, setRoomMsgPage] = (0, import_react14.useState)(1);
  const [roomQuery, setRoomQuery] = (0, import_react14.useState)("");
  const [roomStatus, setRoomStatus] = (0, import_react14.useState)("active");
  const [roomDays, setRoomDays] = (0, import_react14.useState)(0);
  const [roomPage, setRoomPage] = (0, import_react14.useState)(1);
  const [expanded, setExpanded] = (0, import_react14.useState)(null);
  const [fullText, setFullText] = (0, import_react14.useState)({});
  const [openImage, setOpenImage] = (0, import_react14.useState)(null);
  const [openRoom, setOpenRoom] = (0, import_react14.useState)(null);
  const [roomMsgExpanded, setRoomMsgExpanded] = (0, import_react14.useState)(null);
  const [presence, setPresence] = (0, import_react14.useState)({});
  const [error, setError] = (0, import_react14.useState)(null);
  const [notice, setNotice] = (0, import_react14.useState)(null);
  const [copied, setCopied] = (0, import_react14.useState)("");
  ...
  const directMessages = (0, import_react14.useMemo)(() => {
    const items = messages ?? [];
    return items.filter((m) => !m.recipients.some((r) => isRoomRef(r)));
  }, [messages]);
  const filteredMessages = (0, import_react14.useMemo)(() => {
  ...
  const roomMessages = (0, import_react14.useMemo)(() => {
  ...
  const filteredRoomMessages = (0, import_react14.useMemo)(() => {
  ...
  const filteredRooms = (0, import_react14.useMemo)(() => {
    const items = rooms ?? [];
  ...
  const renderMsgCard = (m, expandId, setExpandId) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("div", { className: "bb-card", children: [
      /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("div", { className: "bb-row", children: [
        /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("span", { className: "bb-strong", children: m.subject || "\uFF08\u65E0\u4E3B\u9898\uFF09" }),
        /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("span", { className: `bb-badge${unread ? " bb-badge-unread" : " bb-badge-read"}`, children: unread ? t2("broadcast.msg.unread") : t2("broadcast.msg.read") }),
        m.hasBody && /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("span", { className: "bb-badge bb-badge-long", children: t2("broadcast.messages.long") }),
        /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("span", { className: "bb-grow" }),
        /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("span", { className: "bb-muted bb-small", children: fmtTime2(m.createdAt) }),
        /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("button", { type: "button", className: "bb-btn bb-btn-mini", onClick: () => void toggleExpand(m, expandId, setExpandId), children: isOpen ? t2("broadcast.message.collapse") : t2("broadcast.message.expand") }),
        /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("button", { type: "button", className: "bb-btn bb-btn-mini bb-btn-danger", onClick: () => void deleteMessage(m), children: t2("broadcast.message.delete") })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("div", { className: "bb-muted bb-small", title: m.sender === "system" ? void 0 : m.sender, children: [
      ...
      isOpen && /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("pre", { className: "bb-content", children: fullText[m.id] ?? m.content }),
      Array.isArray(m.attachments) && m.attachments.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("div", { className: "bb-attachments", children: m.attachments.map((a, i) => {
        const key = `${m.id}:${i}`;
        const src = `${API3}/messages/${encodeURIComponent(m.id)}/attachment/${i}`;
        const open = openImage === key;
        return /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("div", { className: "bb-att-item", children: [
          /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(
            "button",
            {
              type: "button",
              ...
              children: /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("img", { src, alt: a.name, loading: "lazy", className: "bb-att-thumb-img" })
            }
          ),
          open && /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("div", { className: "bb-att-preview", onClick: () => setOpenImage(null), children: [
            /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("img", { src, alt: a.name, className: "bb-att-preview-img" }),
            /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("span", { className: "bb-att-preview-name", children: a.name })
          ] })
        ] }, key);
      }) })
    ] }, m.id);
  };
  const renderToolbar = (currentFilter, onFilter, currentQuery, onQuery) => /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("div", { className: "bb-toolbar", children: [
    ["unread", "all", "read"].map((f) => /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(
      "button",
      {
        type: "button",
  ...
  const renderPager = (currentPage, total, onPage) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("div", { className: "bb-pager", children: [
      /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("button", { type: "button", className: "bb-btn bb-btn-mini", disabled: currentPage <= 1, onClick: () => onPage(currentPage - 1), children: t2("broadcast.pagePrev") }),
      /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("span", { className: "bb-muted bb-small", children: t2("broadcast.pageInfo", { page: currentPage, total }) }),
      /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("button", { type: "button", className: "bb-btn bb-btn-mini", disabled: currentPage >= total, onClick: () => onPage(currentPage + 1), children: t2("broadcast.pageNext") })
    ] });
  };
  const myAlias = aliases[sessionId];
  const renderGuide = () => /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(TabGuideView, { sections: [
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("div", { className: "bb-pane", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("div", { className: "bb-session-line", title: sessionId, children: [
      /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("span", { className: "bb-session-label", children: [
        t2("broadcast.mySessionId"),
        "\uFF1A"
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("code", { className: "bb-mono", children: myAlias !== void 0 ? `${myAlias}\uFF08${shortId(sessionId)}\uFF09` : shortId(sessionId) }),
      /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("button", { type: "button", className: "bb-btn bb-btn-mini", onClick: () => copyText(sessionId, "id"), children: copied === "id" ? t2("broadcast.copied") : t2("broadcast.copyId") }),
      myAlias !== void 0 && /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("button", { type: "button", className: "bb-btn bb-btn-mini", onClick: () => copyText(myAlias, "alias"), children: copied === "alias" ? t2("broadcast.copied") : t2("broadcast.copyAlias") })
    ] }),
    notice !== null && /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("div", { className: `bb-notice bb-notice-${notice.kind}`, children: notice.text }),
    error !== null && /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("div", { className: "bb-error", children: error }),
    view === "guide" && renderGuide(),
    view === "settings" && /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(WsCoordSettings, { t: t2 }),
    view === "messages" && /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("div", { className: "bb-list", children: [
      messages === null && /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("div", { className: "bb-empty", children: t2("broadcast.loading") }),
      messages !== null && /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)(import_jsx_runtime16.Fragment, { children: [
        renderToolbar(
          filter,
          (f) => {
            setFilter(f);
        ...
        directMessages.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("div", { className: "bb-empty", children: [
          t2("broadcast.messages.empty"),
          messages.some((m) => m.recipients.some((r) => isRoomRef(r))) && /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("div", { className: "bb-hint", children: t2("broadcast.messages.roomInRooms") })
        ] }),
        directMessages.length > 0 && filteredMessages.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("div", { className: "bb-empty", children: t2("broadcast.messages.empty") }),
        pageItems.map((m) => renderMsgCard(m, expanded, setExpanded)),
        renderPager(page, totalPages, setPage)
      ] })
    ] }),
    view === "rooms" && /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("div", { className: "bb-list", children: [
      rooms === null && /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("div", { className: "bb-empty", children: t2("broadcast.loading") }),
      rooms !== null && /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)(import_jsx_runtime16.Fragment, { children: [
        /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("div", { className: "bb-toolbar", children: [
          ["all", "active", "dissolved"].map((s) => /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(
            "button",
            {
              type: "button",
          ...
          [0, 7, 30].map((d) => /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(
            "button",
            {
              type: "button",
        ...
        filteredRooms.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("div", { className: "bb-empty", children: t2("broadcast.rooms.empty") }),
        roomListPageItems.map((room) => {
          ...
          return /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("div", { className: `bb-card${isOpen ? " bb-card-open" : ""}${dissolved ? " bb-card-dissolved" : ""}`, children: [
            /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("div", { className: "bb-row", children: [
              /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("span", { className: `bb-dot${online ? " bb-dot-on" : dissolved ? " bb-dot-off" : " bb-dot-idle"}` }),
              /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("span", { className: "bb-strong", children: room.name }),
              /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("span", { className: `bb-badge${dissolved ? " bb-badge-dissolved" : online ? " bb-badge-online" : ""}`, children: statusLabel2 }),
              /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("span", { className: "bb-badge", children: t2("broadcast.room.online", { online: room.onlineCount, total: room.members.length }) }),
              /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("span", { className: "bb-grow" }),
              /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("span", { className: "bb-muted bb-small", children: [
                t2("broadcast.room.lastActive"),
                "\uFF1A",
                fmtTime2(room.lastActiveAt)
              ] }),
              /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("button", { type: "button", className: "bb-btn bb-btn-detail", onClick: () => void toggleRoom(room), children: isOpen ? t2("broadcast.message.collapse") : t2("broadcast.room.detail") }),
              !dissolved && /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("button", { type: "button", className: "bb-btn bb-btn-mini bb-btn-danger", onClick: () => void dissolveRoom(room), children: t2("broadcast.room.dissolve") })
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("div", { className: "bb-meta", children: [
              /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("code", { className: "bb-mono bb-small", children: room.id }),
              /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("span", { className: "bb-muted bb-small", children: [
                "\xB7 ",
              ...
              /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("button", { type: "button", className: "bb-btn bb-btn-mini", onClick: () => copyText(room.id, `room-${room.id}`), children: t2("broadcast.room.copyId") })
            ] }),
            isOpen && /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)(import_jsx_runtime16.Fragment, { children: [
              /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("div", { className: "bb-members", children: [
                /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("div", { className: "bb-section-title", children: t2("broadcast.room.members") }),
                members.map((p) => /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("div", { className: "bb-row bb-member", title: p.sessionId, children: [
                  /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("span", { className: `bb-dot${p.online ? " bb-dot-on" : " bb-dot-idle"}` }),
                  /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("code", { className: "bb-mono", children: displayName(p.sessionId, aliases) }),
                  /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("span", { className: "bb-muted bb-small", children: [
                    p.online ? "running" : p.status === "idle" ? "idle" : t2("broadcast.room.presence.unknown"),
                    p.lastActiveAt !== null ? ` \xB7 ${fmtTime2(p.lastActiveAt)}` : ""
                  ] }),
                  /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("span", { className: "bb-grow" }),
                  !dissolved && /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("button", { type: "button", className: "bb-btn bb-btn-mini bb-btn-danger", onClick: () => void kickMember(room, p.sessionId), children: t2("broadcast.room.kick") })
                ] }, p.sessionId))
              ] }),
              /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("div", { className: "bb-room-msgs", children: [
                /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("div", { className: "bb-section-title", children: [
                  t2("broadcast.room.messages"),
                  /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("span", { className: "bb-count", children: roomMessages.length })
                ] }),
                renderToolbar(
                  roomMsgFilter,
                  (f) => {
                ...
                roomMessages.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("div", { className: "bb-empty bb-empty-sm", children: t2("broadcast.room.messages.empty") }),
                roomMessages.length > 0 && filteredRoomMessages.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("div", { className: "bb-empty bb-empty-sm", children: t2("broadcast.room.messages.empty") }),
...
function ScratchView(props) {
  ...
  const [savedContent, setSavedContent] = (0, import_react15.useState)("");
  const [path, setPath] = (0, import_react15.useState)(null);
  const [mtime, setMtime] = (0, import_react15.useState)(null);
  const [saving, setSaving] = (0, import_react15.useState)(false);
  const [saveError, setSaveError] = (0, import_react15.useState)(null);
  const [saveTick, setSaveTick] = (0, import_react15.useState)(0);
  const [openError, setOpenError] = (0, import_react15.useState)(null);
  const [remoteChanged, setRemoteChanged] = (0, import_react15.useState)(false);
  const contentRef = (0, import_react15.useRef)(content);
  const savedContentRef = (0, import_react15.useRef)(savedContent);
  const pathRef = (0, import_react15.useRef)(path);
  ...
  const savingRef = (0, import_react15.useRef)(false);
  ...
  const retryLoad = (0, import_react15.useCallback)(async () => {
    setError(null);
    setOpenError(null);
    void load();
  }, [load]);
  ...
  const openButton = /* @__PURE__ */ (0, import_jsx_runtime17.jsx)("button", { type: "button", className: "sp-btn", onClick: () => void openFile(), title: path ?? "", children: pick(DICT2.zh.open, DICT2.en.open) });
  const statusText = () => {
    if (saving) return pick(DICT2.zh.saving, DICT2.en.saving);
    if (saveError !== null) return saveError;
    if (dirty) return pick(DICT2.zh.dirty, DICT2.en.dirty);
    return mtime === null ? pick(DICT2.zh.neverSaved, DICT2.en.neverSaved) : pick(DICT2.zh.savedAt, DICT2.en.savedAt).replace("{time}", formatTime4(mtime));
  };
  const statusKind = saveError !== null ? "error" : saving || dirty ? "pending" : "ok";
  return /* @__PURE__ */ (0, import_jsx_runtime17.jsxs)("div", { className: "sp-root", children: [
    ...
    view === "guide" ? (
      ...
      /* @__PURE__ */ (0, import_jsx_runtime17.jsx)("div", { className: "sp-head", children: /* @__PURE__ */ (0, import_jsx_runtime17.jsxs)("span", { className: "sp-path", title: path ?? "", children: [
        "\u{1F4DD} ",
        path ?? ""
      ] }) }),
      /* @__PURE__ */ (0, import_jsx_runtime17.jsx)("p", { className: "sp-help", children: pick(DICT2.zh.help, DICT2.en.help) }),
      error !== null && /* @__PURE__ */ (0, import_jsx_runtime17.jsxs)("div", { className: "sp-notice sp-notice-error", children: [
        error,
        /* @__PURE__ */ (0, import_jsx_runtime17.jsxs)("span", { className: "sp-notice-actions", children: [
          /* @__PURE__ */ (0, import_jsx_runtime17.jsx)(
            "button",
            {
              type: "button",
      ...
      openError !== null && /* @__PURE__ */ (0, import_jsx_runtime17.jsx)("div", { className: "sp-notice sp-notice-error", children: openError }),
      remoteChanged && /* @__PURE__ */ (0, import_jsx_runtime17.jsx)("div", { className: "sp-notice sp-notice-warn", children: pick(DICT2.zh.remoteChanged, DICT2.en.remoteChanged) }),
      loaded && /* @__PURE__ */ (0, import_jsx_runtime17.jsxs)(import_jsx_runtime17.Fragment, { children: [
        /* @__PURE__ */ (0, import_jsx_runtime17.jsx)(
          "textarea",
          {
            className: "sp-editor",
        ...
        /* @__PURE__ */ (0, import_jsx_runtime17.jsxs)("div", { className: "sp-toolbar", children: [
          /* @__PURE__ */ (0, import_jsx_runtime17.jsx)("span", { className: `sp-status sp-status-${statusKind}`, children: statusText() }),
          /* @__PURE__ */ (0, import_jsx_runtime17.jsx)("span", { className: "sp-spacer" }),
          openButton
        ] })
      ] }),
      !loaded && error === null && /* @__PURE__ */ (0, import_jsx_runtime17.jsx)("div", { className: "sp-loading", children: pick(DICT2.zh.loading, DICT2.en.loading) })
    ] })
  ] });
}
...
function NumInput(props) {
  return /* @__PURE__ */ (0, import_jsx_runtime18.jsxs)("label", { className: "pm-field pm-num-field", children: [
    /* @__PURE__ */ (0, import_jsx_runtime18.jsxs)("span", { className: "pm-field-label", children: [
      props.label,
      /* @__PURE__ */ (0, import_jsx_runtime18.jsx)("span", { className: "pm-field-hint", children: props.hint })
    ] }),
...
function PromptView(props) {
  ...
  const [injections, setInjections] = (0, import_react16.useState)([]);
  const [sources, setSources] = (0, import_react16.useState)([]);
  const [categories, setCategories] = (0, import_react16.useState)([]);
  const [view, setView] = (0, import_react16.useState)("main");
  const [search, setSearch] = (0, import_react16.useState)("");
  const [category, setCategory] = (0, import_react16.useState)("\u5168\u90E8");
  const [selectedId, setSelectedId] = (0, import_react16.useState)(null);
  const [creating, setCreating] = (0, import_react16.useState)(false);
  const [showInjections, setShowInjections] = (0, import_react16.useState)(false);
  const [showSources, setShowSources] = (0, import_react16.useState)(false);
  const [error, setError] = (0, import_react16.useState)(null);
  const [notice, setNotice] = (0, import_react16.useState)(null);
  const [roundsText, setRoundsText] = (0, import_react16.useState)("0");
  const [everyText, setEveryText] = (0, import_react16.useState)("1");
  const [customOpen, setCustomOpen] = (0, import_react16.useState)(false);
  const [busy, setBusy] = (0, import_react16.useState)(false);
  const [addingCategory, setAddingCategory] = (0, import_react16.useState)(false);
  const [newCategoryName, setNewCategoryName] = (0, import_react16.useState)("");
  const [renamingCategory, setRenamingCategory] = (0, import_react16.useState)(null);
  const [renameValue, setRenameValue] = (0, import_react16.useState)("");
  const [name, setName] = (0, import_react16.useState)("");
  const [description, setDescription] = (0, import_react16.useState)("");
  const [formCategory, setFormCategory] = (0, import_react16.useState)("");
  const [tags, setTags] = (0, import_react16.useState)("");
  const [content, setContent] = (0, import_react16.useState)("");
  const [enabled, setEnabled] = (0, import_react16.useState)(true);
  ...
  const showError = (0, import_react16.useCallback)((err) => {
    setError(errText4(err));
  }, []);
  const showNotice = (0, import_react16.useCallback)((text) => {
    setNotice(text);
  ...
  const displayCategories = (0, import_react16.useMemo)(() => {
  ...
  const uncategorizedCount = (0, import_react16.useMemo)(
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime18.jsxs)("div", { className: "pm-root", children: [
    ...
    view === "guide" ? (
      ...
      /* @__PURE__ */ (0, import_jsx_runtime18.jsxs)("div", { className: "pm-body", children: [
        /* @__PURE__ */ (0, import_jsx_runtime18.jsxs)("div", { className: "pm-pane-cats", children: [
          /* @__PURE__ */ (0, import_jsx_runtime18.jsxs)(
            "button",
            {
              type: "button",
          ...
          displayCategories.map((c) => {
            ...
            if (renamingCategory === c) {
              return /* @__PURE__ */ (0, import_jsx_runtime18.jsxs)("div", { className: "pm-cat-row", children: [
                /* @__PURE__ */ (0, import_jsx_runtime18.jsx)(
                  "input",
                  {
                ...
                /* @__PURE__ */ (0, import_jsx_runtime18.jsx)("button", { type: "button", className: "pm-cat-add-ok", onClick: () => void renameCategory(c), children: "\u2713" })
              ] }, c);
            }
            return /* @__PURE__ */ (0, import_jsx_runtime18.jsxs)("div", { className: "pm-cat-row", children: [
              /* @__PURE__ */ (0, import_jsx_runtime18.jsxs)(
                "button",
                {
                  ...
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime18.jsx)("span", { className: "pm-cat-name", children: c }),
                    /* @__PURE__ */ (0, import_jsx_runtime18.jsx)("span", { className: "pm-cat-count", children: count })
                  ]
                }
              ),
              /* @__PURE__ */ (0, import_jsx_runtime18.jsx)(
          ...
          uncategorizedCount > 0 && /* @__PURE__ */ (0, import_jsx_runtime18.jsxs)(
            "button",
            {
              type: "button",
          ...
          addingCategory ? /* @__PURE__ */ (0, import_jsx_runtime18.jsxs)("div", { className: "pm-cat-add", children: [
            /* @__PURE__ */ (0, import_jsx_runtime18.jsx)(
              "input",
              {
                className: "pm-cat-add-input",
              ...
              "button",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime18.jsxs)("div", { className: "pm-item-row3", children: [
                    ...
                    /* @__PURE__ */ (0, import_jsx_runtime18.jsx)("span", { className: "pm-item-used", children: p.lastUsedAt !== null ? say("lastUsed").replace("{time}", formatTime5(p.lastUsedAt)) : say("neverUsed") })
                  ] })
                ]
              },
              p.id
        ...
        /* @__PURE__ */ (0, import_jsx_runtime18.jsxs)("div", { className: "pm-pane-detail", children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime18.jsxs)("div", { className: "pm-form", children: [
            ...
            customOpen && /* @__PURE__ */ (0, import_jsx_runtime18.jsxs)("div", { className: "pm-custom-zone", children: [
              /* @__PURE__ */ (0, import_jsx_runtime18.jsxs)("div", { className: "pm-num-row", children: [
                /* @__PURE__ */ (0, import_jsx_runtime18.jsx)(
                  NumInput,
                  {
                    label: say("rounds"),
          ...
          (selected !== null || creating) && /* @__PURE__ */ (0, import_jsx_runtime18.jsxs)("div", { className: "pm-form", children: [
              ...
              !creating && (() => {
                ...
                return /* @__PURE__ */ (0, import_jsx_runtime18.jsxs)(import_jsx_runtime18.Fragment, { children: [
                  ...
                  customOpen && /* @__PURE__ */ (0, import_jsx_runtime18.jsxs)("div", { className: "pm-custom-zone pm-custom-zone-inline", children: [
                    /* @__PURE__ */ (0, import_jsx_runtime18.jsxs)("div", { className: "pm-inject-group", children: [
                      /* @__PURE__ */ (0, import_jsx_runtime18.jsx)(
                        NumInput,
                        {
                          label: say("rounds"),
            ...
            !creating && selected !== null && selectedIsDirty && /* @__PURE__ */ (0, import_jsx_runtime18.jsx)("div", { className: "pm-dirty-hint", children: pick2("\u6709\u672A\u4FDD\u5B58\u7684\u4FEE\u6539", "Unsaved changes") })
          ] })
        ] })
      ] })
    ] })
...
function BookmarksView(props) {
  const { t: t2, sessionId } = props;
  const [feature, setFeature] = (0, import_react17.useState)(persistedFeature2 ?? "list");
  const [bookmarks, setBookmarks] = (0, import_react17.useState)(null);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("div", { className: "bm-panel", children: [
    /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("div", { className: "mt-file-tabs", role: "tablist", children: [
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("div", { className: "bm-item-head", children: [
                ...
                /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("span", { className: "bm-item-meta", children: [
                  ...
                  " \xB7 ",
                  formatTime6(bm.createdAt)
                ] })
              ] }),
              bm.summary !== "" && /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("div", { className: "bm-item-summary", children: bm.summary }),
...
// src/client/SyncView.tsx
var import_react18 = require("react");
var import_jsx_runtime20 = require("react/jsx-runtime");
var API4 = "/memory-evolve/memory-sync";
var GLOBAL_FILESET = { memory: "memory-global", user: "user-global", daily: "daily-global", todo: "todo-global" };
var GLOBAL_TRACK_LABEL = {
...
function SyncView(props) {
  ...
  const [conflicts, setConflicts] = (0, import_react18.useState)([]);
  const [globalConflicts, setGlobalConflicts] = (0, import_react18.useState)({});
  const [busy, setBusy] = (0, import_react18.useState)(false);
  const [notice, setNotice] = (0, import_react18.useState)(null);
  const [initialized, setInitialized] = (0, import_react18.useState)(false);
  const [feature, setFeature] = (0, import_react18.useState)("project");
  const [remoteUrl, setRemoteUrl] = (0, import_react18.useState)("");
  const remoteUrlEdited = (0, import_react18.useRef)(false);
  const [remoteOn, setRemoteOn] = (0, import_react18.useState)(false);
  const refresh = (0, import_react18.useCallback)(async () => {
    try {
      const [s, c] = await Promise.all([
        api6(`/status?sessionId=${encodeURIComponent(sessionId)}`),
        api6(`/conflicts?sessionId=${encodeURIComponent(sessionId)}`)
      ]);
      const nextStatus = "status" in s && s.status !== void 0 ? s.status : s;
      ...
      const gTracks = Object.keys(gCounts).filter((track) => (gCounts[track] ?? 0) > 0);
      await Promise.all(gTracks.map(async (track) => {
        const fileset = GLOBAL_FILESET[track];
        if (!fileset) return;
        const r = await api6(`/conflicts?sessionId=${encodeURIComponent(sessionId)}&fileset=${encodeURIComponent(fileset)}`);
  ...
  const setProjectMode = async (mode) => {
    if (mode === "off") {
      const r2 = await api6("/off", { method: "POST", body: JSON.stringify({ sessionId }) });
      return r2;
    }
    if (mode === "shared") {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime20.jsx)("div", { className: "mt-panel", children: !initialized ? /* @__PURE__ */ (0, import_jsx_runtime20.jsx)("div", { className: "bb-empty", children: t2("syncTab.loading") }) : /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)(import_jsx_runtime20.Fragment, { children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)("label", { className: `sv-radio-row${status?.projectEnabled === true && status?.remoteKind === "shared-repo" ? " sv-radio-active" : ""}`, children: [
            /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(
              "input",
              {
                ...
                onChange: () => {
                  void run(() => setProjectMode("shared"));
                }
              }
            ),
            /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)("span", { style: { flex: 1 }, children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(
            "input",
            {
              ...
              onChange: (event) => {
                ...
                void run(() => api6("/global-track", { method: "POST", body: JSON.stringify({ sessionId, track, on: target }) }));
              }
            }
          )
        ] }, track)),
    ...
    feature === "remote" && /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)("div", { className: "sv-section", children: [
      ...
      remoteOn ? /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)(import_jsx_runtime20.Fragment, { children: [
        /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)("div", { className: "sv-actions", style: { marginTop: "10px" }, children: [
          /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(
            "input",
            {
              type: "text",
...
function TurnBookmarkButton(props) {
  ...
  const [bookmark, setBookmark] = (0, import_react19.useState)(null);
  ...
  const reload = (0, import_react19.useCallback)(() => {
    const sessionId = resolveSessionId(props.sessionId);
    if (!sessionId) return;
    void api7(`?sessionId=${encodeURIComponent(sessionId)}`).then((data) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime21.jsxs)("div", { className: "bm-star-wrap", ref: wrapRef, "data-bm-seq": String(seq), children: [
    /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(
      "button",
      {
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime21.jsx)("span", { className: "bm-star-icon", "aria-hidden": "true", children: bookmarked ? "\u2605" : "\u2606" })
      }
    ),
...
var zh = {
  ...
  "settingsTab.label.pending": "\u{1F534} Memory Evolve \u8BBE\u7F6E",
  ...
  "syncTab.status.counts": "\u672A\u63A8\u9001 {pending} \u6761 \xB7 \u843D\u540E\u8FDC\u7AEF {behind} \u4E2A\u63D0\u4EA4 \xB7 \u51B2\u7A81 {conflicts} \u6761",
...
var en = {
  ...
  "settingsTab.label.pending": "\u{1F534} Memory Evolve Settings",
  ...
  "syncTab.status.counts": "{pending} not pushed \xB7 {behind} behind \xB7 {conflicts} conflicts",
...
function apply(ctx) {
  ...
  const registerSyncTab = () => {
    disposeSyncTab?.();
    disposeSyncTab = ctx.slots.inject("conversation.view", () => ctx.slots.register({
      name: "conversation.view",
      id: "memory-sync-hub",
      order: 80,
  ...
  void fetch("/memory-evolve/api/config").then((res) => res.ok ? res.json() : Promise.reject(new Error(`HTTP ${res.status}`))).then((data) => {
    ...
    if (!tabCancelled && data.config?.syncEnabled === true && disposeSyncTab === void 0) {
      registerSyncTab();
    }
