...
function UiSettingsTabView(props) {
  const { t: t2 } = props;
  const [feature, setFeature] = (0, import_react9.useState)(persistedUiSettingsFeature ?? "guide");
  (0, import_react9.useEffect)(() => {
    persistedUiSettingsFeature = feature;
  }, [feature]);
  const renderGuide = () => /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(TabGuideView, { sections: [
    { icon: "\u{1F3A8}", title: t2("uiSettingsTab.guide.what.title"), body: t2("uiSettingsTab.guide.what.body"), items: [t2("uiSettingsTab.guide.what.item1"), t2("uiSettingsTab.guide.what.item2"), t2("uiSettingsTab.guide.what.item3")] },
    { icon: "\u{1F50D}", title: t2("uiSettingsTab.guide.filter.title"), body: t2("uiSettingsTab.guide.filter.body"), items: [t2("uiSettingsTab.guide.filter.item1"), t2("uiSettingsTab.guide.filter.item2"), t2("uiSettingsTab.guide.filter.item3")] },
    { icon: "\u2699\uFE0F", title: t2("uiSettingsTab.guide.switch.title"), body: t2("uiSettingsTab.guide.switch.body") }
  ] });
  return /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { className: "me-panel", children: [
    /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("div", { className: "mt-file-tabs", role: "tablist", children: /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(
      "button",
      {
        type: "button",
        role: "tab",
        ...
        roomListPageItems.map((room) => {
          ...
          return /* @__PURE__ */ (0, import_jsx_runtime15.jsxs)("div", { className: `bb-card${isOpen ? " bb-card-open" : ""}${dissolved ? " bb-card-dissolved" : ""}`, children: [
            /* @__PURE__ */ (0, import_jsx_runtime15.jsxs)("div", { className: "bb-row", children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("span", { className: `bb-badge${dissolved ? " bb-badge-dissolved" : online ? " bb-badge-online" : ""}`, children: statusLabel }),
...
function activateSessionFilter(texts) {
  let mode = readPref();
  let disposed = false;
...
function apply(ctx) {
  ...
  void fetch("/memory-evolve/api/ui-settings/state").then((res) => res.ok ? res.json() : Promise.reject(new Error(`HTTP ${res.status}`))).then((data) => {
    ...
    disposeSessionFilter = activateSessionFilter({
      barTitle: t2("uiSettingsTab.guide.filter.body"),
