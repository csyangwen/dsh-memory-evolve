...
function BroadcastView(props) {
  ...
  const [roomFilter, setRoomFilter] = (0, import_react12.useState)("unread");
  ...
  const roomPageItems = filteredRoomMessages.slice((roomPage - 1) * PAGE_SIZE2, roomPage * PAGE_SIZE2);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("div", { className: "bb-pane", children: [
    ...
    view === "rooms" && /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("div", { className: "bb-list", children: [
      ...
      rooms !== null && rooms.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("div", { className: "bb-empty", children: t2("broadcast.rooms.empty") }),
      rooms?.map((room) => {
