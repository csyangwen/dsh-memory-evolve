...
function SyncView(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("div", { className: "mt-panel", children: !initialized ? /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("div", { className: "bb-empty", children: t2("syncTab.loading") }) : /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)(import_jsx_runtime19.Fragment, { children: [
    ...
    feature === "remote" && /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("div", { className: "sv-section", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("div", { className: "sv-actions", style: { marginTop: "8px" }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(
          "input",
          {
            type: "text",
        ...
        /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(
          "button",
          {
            ...
            onClick: () => {
              void run(() => api6("/global-remote", { method: "POST", body: JSON.stringify({ url: remoteUrl.trim() }) }));
            },
            children: t2("syncTab.remote.save")
          }
        )
      ] }),
...
var zh = {
  ...
  "syncTab.project.mode.shared.needRemote": "\u5171\u4EAB\u8BB0\u5FC6\u4ED3\u5E93\u5C1A\u672A\u914D\u7F6E\u2014\u2014\u5DF2\u5207\u6362\u5230\u300C\u8BB0\u5FC6\u8FDC\u7AEF\u300D\uFF0C\u8BF7\u5148\u4FDD\u5B58\u4ED3\u5E93\u5730\u5740",
  ...
  "syncTab.global.notInit": "\u5168\u5C40\u8BB0\u5FC6\u540C\u6B65\u9700\u8981\u5171\u4EAB\u8BB0\u5FC6\u4ED3\u5E93\u2014\u2014\u8BF7\u5230\u300C\u8BB0\u5FC6\u8FDC\u7AEF\u300D\u9875\u4FDD\u5B58\u4ED3\u5E93\u5730\u5740",
  "syncTab.remote.desc": "\u8FD9\u662F\u5168\u8BBE\u5907\u7684\u7EDF\u4E00\u8BB0\u5FC6\u4ED3\u5E93\u5730\u5740\uFF1A\u9879\u76EE B \u6A21\u5F0F\u4E0E\u5168\u5C40\u8BB0\u5FC6\uFF08\u7528\u6237\u6863\u6848/\u6BCF\u65E5\u65E5\u5FD7/\u5F85\u529E\uFF09\u90FD\u5F15\u7528\u5B83\uFF0C\u914D\u7F6E\u4E00\u6B21\u5373\u53EF\u3002",
  "syncTab.remote.placeholder": "\u7C98\u8D34\u5171\u4EAB\u8BB0\u5FC6\u4ED3\u5E93\u5730\u5740\uFF08\u5982 ssh://git@.../dsh-memories.git\uFF09",
  "syncTab.remote.save": "\u4FDD\u5B58",
  "syncTab.remote.current": "\u5F53\u524D\u5171\u4EAB\u8BB0\u5FC6\u4ED3\u5E93\uFF1A{url}",
...
var en = {
  ...
  "syncTab.tab.remote": "Memory remote",
  ...
  "syncTab.project.mode.shared.needRemote": 'Shared memory repo is not configured yet \u2014 switched to "Memory remote", please save the repo URL first',
  ...
  "syncTab.global.notInit": 'Global memory sync needs a shared memory repo \u2014 save the repo URL on the "Memory remote" page first',
  "syncTab.remote.desc": "One shared memory repo URL for the whole device: project Mode B and global memory (user profile / daily logs / todos) both reference it \u2014 configure once.",
  "syncTab.remote.placeholder": "Paste a shared memory repo URL (e.g. ssh://git@.../dsh-memories.git)",
  "syncTab.remote.save": "Save",
