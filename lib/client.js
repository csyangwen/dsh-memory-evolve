...
function MemoryTabView(props) {
  ...
  const openWithSystem = (row) => {
    ...
    void api2("/api/reveal", { method: "POST", body: JSON.stringify({ target }) }).then(() => setNotice({ kind: "ok", text: t("memoryTab.opened") })).catch((error) => setNotice({ kind: "error", text: error.message }));
  };
  const save = (row) => {
    setSaving(row.key);
    setNotice(null);
    void api2("/api/memory-files/save", {
      ...
      setNotice({ kind: "ok", text: t("memoryTab.saved") });
      load();
    }).catch((error) => {
      setNotice({ kind: "error", text: error.message });
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "mt-panel", children: [
    ...
    files === null ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { className: "mt-muted", children: t("memoryTab.loading") }) : /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "mt-list", children: files.map((row) => /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "mt-card", children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "mt-card-head", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "mt-card-actions", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("button", { type: "button", className: "mt-btn", onClick: () => openWithSystem(row), children: t("memoryTab.open") }) })
      ] }),
