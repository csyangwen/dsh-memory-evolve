...
function MemoryTabView(props) {
  ...
  const save = (row) => {
    setSaving(row.key);
    setNotice(null);
    void api2("/api/memory-files/save", {
      method: "POST",
      body: JSON.stringify({
        key: row.key,
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "mt-panel", children: [
    ...
    files === null ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { className: "mt-muted", children: t("memoryTab.loading") }) : /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "mt-list", children: files.map((row) => {
      const dirty = row.available && (drafts[row.key] ?? row.content) !== row.content;
      return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "mt-card", children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "mt-card-head", children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: `mt-badge ${row.editable ? "mt-badge-edit" : "mt-badge-ro"}`, children: row.editable ? t("memoryTab.editable") : t("memoryTab.readonly") }),
        ...
        !row.available ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { className: "mt-muted", children: t("memoryTab.noCwd") }) : row.editable ? /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "mt-edit", children: [
          !row.exists && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { className: "mt-muted", children: t("memoryTab.willCreate") }),
          ...
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "mt-edit-actions", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
            "button",
            {
              type: "button",
              className: "mt-btn mt-btn-primary",
              disabled: saving === row.key || !dirty || row.truncated,
              title: row.truncated ? t("memoryTab.truncatedSaveBlocked") : void 0,
              onClick: () => save(row),
              children: saving === row.key ? t("memoryTab.saving") : t("memoryTab.save")
            }
          ) })
        ] }) : /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("pre", { className: "mt-content", children: row.exists ? row.content : t("memoryTab.empty") }),
...
var zh = {
  ...
  "memoryTab.willCreate": "\uFF08\u6587\u4EF6\u4E0D\u5B58\u5728\uFF0C\u4FDD\u5B58\u65F6\u5C06\u521B\u5EFA\uFF09",
  "memoryTab.truncatedSaveBlocked": "\u5185\u5BB9\u8FC7\u957F\u5DF2\u622A\u65AD\uFF0C\u4E3A\u907F\u514D\u8986\u76D6\u539F\u6587\u4EF6\u8BF7\u5148\u4F7F\u7528\u7CFB\u7EDF\u5DE5\u5177\u7F16\u8F91",
...
var en = {
  ...
  "memoryTab.willCreate": "(file missing \u2014 saving will create it)",
  "memoryTab.truncatedSaveBlocked": "Truncated content would overwrite the file \u2014 edit with the system tool instead",
