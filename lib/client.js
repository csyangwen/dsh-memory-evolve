...
function MemoryPanel(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "me-panel", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", { className: "me-block", children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "me-block-head", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", { className: "me-heading", children: t("panel.archive.title") }),
        archived !== null && archived.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "me-count", children: archived.length })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "me-help", children: t("panel.archive.help") }),
      archived === null ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "me-muted", children: t("panel.loading") }) : archived.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "me-empty", children: t("panel.archive.empty") }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", { className: "me-list me-archive-list", children: archived.map((entry, index) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", { className: "me-item", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "me-item-head", children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "me-badge me-badge-target", children: entry.target }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { className: "me-item-actions", children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
              "button",
              {
                ...
                children: t("panel.archive.promote")
              }
            ),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
              "button",
              {
                ...
                children: t("panel.archive.delete")
              }
            )
          ] })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("pre", { className: "me-archive-content", children: entry.content })
      ] }, `${entry.target}-${index}`)) })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", { className: "me-block", children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "me-block-head", children: [
...
var ENTRY_KEYS = /* @__PURE__ */ new Set(["memory", "user", "archive-memory", "archive-user", "project", "daily"]);
...
function MemoryTabView(props) {
  ...
  const openWithSystem = (row) => {
    const target = row.key === "memory" ? "memoryFile" : row.key === "user" ? "userFile" : row.key === "daily" ? "dailyFile" : row.key === "project" ? "projectsDir" : row.key === "archive-memory" ? "archiveMemoryFile" : row.key === "archive-user" ? "archiveUserFile" : "agentsFile";
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "mt-panel", children: [
    ...
    files === null ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { className: "mt-muted", children: t("memoryTab.loading") }) : /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "mt-file-tabs", role: "tablist", children: (files ?? []).map((row) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
        "button",
        {
          type: "button",
          role: "tab",
      ...
      activeRow !== null && /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "mt-card", children: [
        ...
        !activeRow.available ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { className: "mt-muted", children: t("memoryTab.noCwd") }) : !activeRow.exists ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("pre", { className: "mt-content", children: t("memoryTab.empty") }) : activeEntries === null ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("pre", { className: "mt-content", children: activeRow.content }) : /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "mt-entries", children: [...activeEntries].reverse().map((entry, index) => /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "mt-entry", children: [
          (entry.time !== null || entry.tag !== null) && /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "mt-entry-head", children: [
