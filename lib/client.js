...
function SyncView(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("div", { className: "mt-panel", children: !initialized ? /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("div", { className: "bb-empty", children: t2("syncTab.loading") }) : /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)(import_jsx_runtime19.Fragment, { children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(
        "input",
        {
          ...
          onChange: (event) => {
            ...
            void run(() => api6("/project-enabled", { method: "POST", body: JSON.stringify({ sessionId, enabled: target }) }));
          }
        }
      )
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("label", { className: "me-field", children: [
      /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("span", { className: "me-field-label", children: [
        t2("syncTab.trackProject"),
        /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("em", { className: "me-field-hint", children: t2("syncTab.trackProject.hint") })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(
        "input",
        {
          ...
          onChange: (event) => {
            const target = event.target.checked;
            void run(() => api6("/track", { method: "POST", body: JSON.stringify({ sessionId, on: target }) }));
          }
        }
      )
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("div", { className: "bb-settings", style: sectionStyle, children: [
      /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("div", { className: "bb-settings-title", children: t2("syncTab.status.title") }),
      status?.enabled !== true ? /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("p", { className: "bb-settings-desc", children: t2("syncTab.status.disabled") }) : status?.initialized !== true ? /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("p", { className: "bb-settings-desc", children: t2("syncTab.status.notInit") }) : /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)(import_jsx_runtime19.Fragment, { children: [
        /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("p", { className: "bb-settings-desc", children: [
          /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("strong", { children: t2("syncTab.status.identity", { name: status?.identity?.displayName ?? "?", kind: status?.identity?.kind === "remote" ? t2("syncTab.status.remote") : t2("syncTab.status.local") }) }),
          /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("br", {}),
          t2("syncTab.status.identity.hint")
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("p", { className: "bb-settings-desc", children: [
        ...
        status?.migrateFrom != null && /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("p", { className: "bb-settings-desc", children: t2("syncTab.status.migrate", { dir: status.migrateFrom }) })
      ] })
    ] }),
    status?.enabled === true && /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("div", { className: "bb-settings", style: sectionStyle, children: [
      /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("div", { className: "bb-settings-title", children: t2("syncTab.actions.title") }),
      /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("div", { className: "bb-actions", children: [
        status?.initialized !== true && /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("button", { type: "button", className: "me-btn me-btn-primary", disabled: busy, onClick: () => {
          void run(() => api6("/setup", { method: "POST", body: JSON.stringify({ sessionId }) }));
        }, children: t2("syncTab.actions.setupDefault") }),
        status?.initialized === true && /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)(import_jsx_runtime19.Fragment, { children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("button", { type: "button", className: "me-btn me-btn-danger", disabled: busy, onClick: () => {
            void run(() => api6("/off", { method: "POST", body: JSON.stringify({ sessionId }) }));
          }, children: t2("syncTab.actions.off") })
        ] })
      ] })
    ] }),
    status?.enabled === true && /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("div", { className: "bb-settings", style: sectionStyle, children: [
      /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("div", { className: "bb-settings-title", children: t2("syncTab.remote.configTitle") }),
      /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("div", { className: "bb-actions", style: { display: "flex", flexDirection: "column", alignItems: "stretch", gap: "8px" }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("em", { className: "bb-meta", children: status?.initialized === true ? t2("syncTab.actions.switchShared.hint") : t2("syncTab.actions.setupShared.hint") }),
        /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("span", { className: "bb-actions-inline", style: { display: "flex", flexWrap: "wrap", alignItems: "center", gap: "8px", width: "100%", minWidth: 0 }, children: [
          /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(
            "input",
            {
              type: "text",
              ...
              placeholder: t2("syncTab.actions.setupShared.placeholder"),
              value: remoteUrl,
              onChange: (event) => {
          ...
          /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(
            "button",
            {
              ...
              children: status?.initialized === true ? t2("syncTab.actions.switchShared") : t2("syncTab.actions.setupShared")
            }
          )
        ] })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("details", { className: "bb-settings-desc", style: { marginTop: "10px" }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("summary", { style: { cursor: "pointer" }, children: t2("syncTab.remote.title") }),
        /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("div", { style: { marginTop: "6px" }, children: [
          /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("p", { children: [
            /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("strong", { children: t2("syncTab.remote.default.title") }),
            "\uFF1A",
            t2("syncTab.remote.default.desc")
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("p", { children: [
            /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("strong", { children: t2("syncTab.remote.shared.title") }),
            "\uFF1A",
            t2("syncTab.remote.shared.desc")
          ] })
        ] })
      ] })
    ] }),
    status?.enabled === true && status?.global?.initialized === true && /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("div", { className: "bb-settings", style: sectionStyle, children: [
      /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("div", { className: "bb-settings-title", children: t2("syncTab.global.title") }),
      /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("p", { className: "bb-settings-desc", children: [
        t2("syncTab.global.url", { url: status.global.url }),
        /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("br", {}),
      ...
      /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("p", { className: "bb-meta", children: t2("syncTab.global.hint") }),
      /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("div", { className: "bb-actions", children: [
        /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("button", { type: "button", className: "me-btn me-btn-primary", disabled: busy, onClick: () => {
    ...
    status?.enabled === true && conflicts.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("div", { className: "bb-settings", style: sectionStyle, children: [
      /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("div", { className: "bb-settings-title", children: t2("syncTab.conflicts.title", { count: conflicts.length }) }),
...
var zh = {
  ...
  "syncTab.trackProject": "\u540C\u6B65\u8303\u56F4\uFF1A\u9879\u76EE\u8BB0\u5FC6\u8F68",
  "syncTab.trackProject.hint": "\u8F68\u7EA7\u5F00\u5173\uFF1A\u9879\u76EE\u8BB0\u5FC6\uFF08KEY + \u9879\u76EE\u65E5\u5FD7 + \u5F52\u6863 + \u9879\u76EE\u5F85\u529E\uFF09\u662F\u5426\u53C2\u4E0E\u540C\u6B65\u3002\u9879\u76EE\u8BB0\u5FC6\u53EA\u662F\u8BB0\u5FC6\u6A21\u5757\u7684\u4E00\u90E8\u5206\uFF1B\u5168\u5C40\u8F68\u5728\u4E0B\u65B9\u5355\u72EC\u914D\u7F6E\uFF0C\u4E14\u4EC5\u5171\u4EAB\u8BB0\u5FC6\u4ED3\u5E93\u53EF\u7528\u3002\u5173\u95ED\u672C\u8F68 = \u8BE5\u8F68\u4FDD\u7559\u672C\u5730\u4E0D\u518D\u5BF9\u8D26",
  ...
  "syncTab.status.identity.hint": "\u6765\u81EA\u4EE3\u7801\u4ED3\u5E93\u5730\u5740\uFF0C\u662F\u4E0D\u540C\u8BBE\u5907\u8BC6\u522B\u540C\u4E00\u9879\u76EE\u7684\u8BA4\u4EB2\u951A\u70B9\uFF1B\u5B83\u4E0D\u4EE3\u8868\u8BB0\u5FC6\u5B58\u653E\u4F4D\u7F6E\uFF0C\u5207\u6362\u8BB0\u5FC6\u8FDC\u7AEF\u4E5F\u4E0D\u4F1A\u6539\u53D8\u9879\u76EE\u8EAB\u4EFD\u3002",
  "syncTab.status.remote": "\u4EE3\u7801\u4ED3\u5E93\u5730\u5740",
  "syncTab.status.local": "\u672C\u5730\u4FE1\u606F",
  ...
  "syncTab.status.remoteKind.hint": "\u8FD9\u662F\u8BB0\u5FC6\u5B9E\u9645\u5B58\u653E\u548C\u5BF9\u8D26\u7684\u4F4D\u7F6E\uFF0C\u53EF\u4EE5\u5728\u4E0B\u65B9\u5355\u72EC\u5207\u6362\uFF0C\u4E0D\u5F71\u54CD\u9879\u76EE\u8EAB\u4EFD\u3002",
  ...
  "syncTab.global.title": "\u5168\u5C40\u8BB0\u5FC6\u540C\u6B65",
  "syncTab.global.url": "\u8BB0\u5FC6\u8FDC\u7AEF\uFF1A{url}\uFF08\u4E00\u4E2A\u5171\u4EAB\u8BB0\u5FC6\u4ED3\u5E93\u88C5\u6240\u6709\u5168\u5C40\u8BB0\u5FC6\uFF09",
  ...
  "syncTab.global.sync": "\u5168\u5C40\u540C\u6B65\uFF08\u62C9\u53D6\u5E76\u5408\u5E76\uFF09",
  "syncTab.global.push": "\u5168\u5C40\u540C\u6B65\u5E76\u63A8\u9001\uFF08\u9700\u4F60\u663E\u5F0F\u70B9\u51FB\uFF09",
  "syncTab.actions.title": "\u9879\u76EE\u540C\u6B65\u64CD\u4F5C",
  "syncTab.remote.configTitle": "\u8BB0\u5FC6\u8FDC\u7AEF\u914D\u7F6E",
  ...
  "syncTab.actions.setupShared.placeholder": "\u7C98\u8D34\u5171\u4EAB\u8BB0\u5FC6\u4ED3\u5E93\u5730\u5740",
  "syncTab.actions.setupShared.hint": "\u586B\u4E86\u5B83\uFF1A\u672C\u9879\u76EE\u7684\u8BB0\u5FC6\u4F1A\u81EA\u52A8\u8F6C\u5230\u8FD9\u4E2A\u4ED3\u5E93\uFF08\u8001\u914D\u7F6E\u81EA\u52A8\u517C\u5BB9\uFF0C\u65E7\u5206\u652F\u81EA\u52A8\u7559\u6863\uFF09",
  "syncTab.actions.switchShared": "\u5207\u6362\u5230\u8FD9\u4E2A\u4ED3\u5E93",
  "syncTab.actions.switchShared.hint": "\u5DF2\u521D\u59CB\u5316\u9879\u76EE\u5207\u6362\u8BB0\u5FC6\u8FDC\u7AEF\uFF1A\u672C\u5730\u8BB0\u5FC6\u5B8C\u6574\u4FDD\u7559\u3001\u65E7\u5206\u652F\u7559\u6863\uFF0C\u5207\u6362\u540E\u9996\u6B21\u6267\u884C\u300C\u540C\u6B65\u300D\u5B8C\u6210\u5BF9\u8D26",
...
var en = {
  ...
  "syncTab.trackProject": "Scope: project memory track",
  "syncTab.trackProject.hint": "Track-level switch: whether project memory (KEY + project log + archive + project todos) participates. Project memory is only part of the memory module; global tracks are configured separately below and require a shared memory repo. Turning this off keeps this track local",
  ...
  "syncTab.status.identity": "Project identity: {name} ({kind})",
  "syncTab.status.identity.hint": "Derived from the code repository URL, this is the cross-device anchor used to recognize the same project. It is not where memory is stored, and changing the memory remote does not change it.",
  "syncTab.status.remote": "code repository URL",
  "syncTab.status.local": "local information",
  ...
  "syncTab.status.remoteKind.hint": "This is where memory is actually stored and reconciled. You can switch it separately below without affecting the project identity.",
  ...
  "syncTab.global.title": "Global memory sync",
  "syncTab.global.url": "Memory remote: {url} (one shared memory repo holds all global memory)",
  ...
  "syncTab.global.sync": "Global sync (fetch & merge)",
  "syncTab.global.push": "Global sync & push (explicit click = consent)",
  "syncTab.actions.title": "Project sync actions",
  "syncTab.remote.configTitle": "Memory remote settings",
  ...
  "syncTab.actions.setupShared.placeholder": "Paste a shared memory repo URL",
  "syncTab.actions.setupShared.hint": "When filled: this project's memory automatically moves to this repo (old configs auto-compatible, old branches stay archived)",
  "syncTab.actions.switchShared": "Switch to this repo",
  "syncTab.actions.switchShared.hint": 'For an initialized project: switching the memory remote keeps all local memory and archives the old branch; run "Sync" once after switching to reconcile',
