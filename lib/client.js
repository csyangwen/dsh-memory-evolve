...
function SyncView(props) {
  ...
  const [remoteMode, setRemoteMode] = (0, import_react17.useState)("main");
  ...
  const setProjectSync = async (on) => {
    const r1 = await api6("/project-enabled", { method: "POST", body: JSON.stringify({ sessionId, enabled: on }) });
    const r2 = await api6("/track", { method: "POST", body: JSON.stringify({ sessionId, on }) });
    const texts = [r1.text, r2.text].filter(Boolean);
    return { ok: r1.ok && r2.ok, text: texts.join("\uFF1B") };
  };
  const syncAll = async (push) => {
    const parts = [];
    let ok = true;
    if (status?.initialized === true) {
      const r = await api6("/sync", { method: "POST", body: JSON.stringify({ sessionId, ...push ? { push: true } : {} }) });
      if (!r.ok) ok = false;
      parts.push(r.text);
    }
    ...
    if (status?.global?.initialized === true && anyGlobalOn) {
      const r = await api6("/global-sync", { method: "POST", body: JSON.stringify({ sessionId, ...push ? { push: true } : {} }) });
      if (!r.ok) ok = false;
      parts.push(r.text);
    }
    if (parts.length === 0) return { ok: false, text: t2("syncTab.actions.nothingToSync") };
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("div", { className: "mt-panel", children: !initialized ? /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("div", { className: "bb-empty", children: t2("syncTab.loading") }) : /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)(import_jsx_runtime19.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("div", { className: "me-notice me-notice-warn", style: { marginBottom: "8px" }, children: t2("syncTab.betaWarning") }),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("div", { className: "sv-section", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("label", { className: "me-field", children: [
        /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("span", { className: "me-field-label", children: [
          t2("syncTab.projectEnabled"),
          /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("em", { className: "me-field-hint", children: t2("syncTab.projectEnabled.hint") })
        ] }),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("div", { className: "sv-section", children: [
      ...
      status?.global?.initialized === true ? /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)(import_jsx_runtime19.Fragment, { children: [
        [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("p", { className: "bb-meta", children: [
          t2("syncTab.global.uncommitted", { n: String(status.global.uncommitted ?? 0) }),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("div", { className: "sv-section", children: [
      /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("div", { className: "sv-section-title", children: t2("syncTab.section.sync") }),
      /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("div", { className: "sv-status", children: status?.enabled !== true ? t2("syncTab.status.disabled") : status?.initialized !== true ? t2("syncTab.status.notInit") : /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)(import_jsx_runtime19.Fragment, { children: [
        /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("p", { children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("br", {}),
          t2("syncTab.status.originUrl", { url: status?.originUrl || t2("syncTab.status.remoteKindNone") }),
          /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("br", {}),
          t2("syncTab.status.remoteKind.hint")
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("p", { children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("div", { style: { display: "flex", flexDirection: "column", gap: "8px" }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("label", { className: `sv-radio-row${remoteMode === "main" ? " sv-radio-active" : ""}`, children: [
          /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(
            "input",
            {
              type: "radio",
          ...
          /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("span", { style: { flex: 1 }, children: [
            /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("span", { className: "sv-radio-label", children: t2("syncTab.remote.modeMain") }),
            /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("span", { className: "sv-radio-desc", children: t2("syncTab.remote.modeMain.desc") })
          ] })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("label", { className: `sv-radio-row${remoteMode === "shared" ? " sv-radio-active" : ""}`, children: [
          /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(
            "input",
            {
              type: "radio",
          ...
          /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("span", { style: { flex: 1 }, children: [
            /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("span", { className: "sv-radio-label", children: t2("syncTab.remote.modeShared") }),
            /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("span", { className: "sv-radio-desc", children: t2("syncTab.remote.modeShared.desc") })
          ] })
        ] })
      ] }),
      remoteMode === "shared" && /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("div", { className: "sv-actions", style: { marginTop: "8px" }, children: /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(
        "input",
        {
          type: "text",
          className: "me-input",
      ...
      /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("div", { className: "sv-actions", children: [
        remoteMode === "shared" ? /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(
          "button",
          {
            type: "button",
            ...
            onClick: () => {
              void run(() => api6("/setup", { method: "POST", body: JSON.stringify({ sessionId, url: remoteUrl.trim() }) }));
            },
            children: t2("syncTab.remote.applyShared")
          }
        ) : /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(
          "button",
          {
            ...
            onClick: () => {
              void run(() => api6("/setup", { method: "POST", body: JSON.stringify({ sessionId }) }));
            },
            children: t2("syncTab.remote.applyMain")
          }
        ),
        status?.remoteKind === "shared-repo" || status?.remoteKind === "main-repo" ? /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("span", { className: "sv-current-badge", children: status?.remoteKind === "shared-repo" ? t2("syncTab.remote.currentShared") : t2("syncTab.remote.currentMain") }) : null
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("p", { className: "bb-meta", style: { marginTop: "6px" }, children: t2("syncTab.remote.switchHint") }),
      /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("div", { className: "sv-actions", children: status?.initialized !== true ? /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("button", { type: "button", className: "me-btn me-btn-primary", disabled: busy || status?.enabled !== true, onClick: () => {
        void run(() => api6("/setup", { method: "POST", body: JSON.stringify({ sessionId }) }));
      }, children: t2("syncTab.actions.setupDefault") }) : /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)(import_jsx_runtime19.Fragment, { children: [
        /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("button", { type: "button", className: "me-btn me-btn-primary", disabled: busy, onClick: () => {
          void run(() => syncAll(false));
...
var zh = {
  ...
  "syncTab.projectEnabled.hint": "\u9879\u76EE\u7EA7\u5F00\u5173\uFF08\u9ED8\u8BA4\u5173\uFF09\uFF1A\u6253\u5F00 = \u540C\u6B65\u672C\u9879\u76EE\u7684\u5168\u90E8\u9879\u76EE\u8BB0\u5FC6\uFF08KEY + \u9879\u76EE\u65E5\u5FD7 + \u5F52\u6863 + \u9879\u76EE\u5F85\u529E\uFF09\u5E76\u5F00\u59CB\u5BF9\u8D26\uFF0C\u8BB0\u5FC6\u8FDC\u7AEF\u9ED8\u8BA4\u7528\u4F60\u7684\u4EE3\u7801\u4ED3\u5E93\uFF08\u96F6\u914D\u7F6E\uFF09\uFF0C\u4E5F\u53EF\u5728\u4E0B\u65B9\u5207\u6362\u5230\u5171\u4EAB\u8BB0\u5FC6\u4ED3\u5E93\u3002\u5173\u95ED = \u672C\u9879\u76EE\u505C\u7528\uFF08\u8BB0\u5FC6\u5B8C\u6574\u4FDD\u7559\u672C\u5730\uFF0C\u968F\u65F6\u53EF\u91CD\u65B0\u542F\u7528\uFF09\u3002**\u672A\u6253\u5F00\u7684\u9879\u76EE\u4FDD\u6301\u672A\u5F00\u53D1\u672C\u6A21\u5757\u524D\u7684\u7EAF\u672C\u5730\u72B6\u6001**\uFF08\u4E0D\u5EFA Git \u4ED3\u5E93\u3001\u4E0D\u751F\u6210\u8EAB\u4EFD\u8BC1\uFF09",
  "syncTab.section.project": "\u672C\u9879\u76EE",
  "syncTab.section.global": "\u5168\u5C40\u8BB0\u5FC6\uFF08\u4E0D\u5C5E\u4E8E\u672C\u9879\u76EE\uFF09",
  "syncTab.section.sync": "\u8BB0\u5FC6\u8FDC\u7AEF\u4E0E\u540C\u6B65",
  "syncTab.status.title": "\u5F53\u524D\u8BB0\u5FC6\u8FDC\u7AEF",
  "syncTab.status.disabled": "\u672A\u542F\u7528\u2014\u2014\u6253\u5F00\u4E0A\u65B9\u300C\u672C\u9879\u76EE\u540C\u6B65\u300D\u5F00\u5173\u5F00\u59CB",
  "syncTab.status.notInit": "\u5DF2\u542F\u7528\uFF0C\u4F46\u5F53\u524D\u9879\u76EE\u5C1A\u672A\u521D\u59CB\u5316\u2014\u2014\u70B9\u4E0B\u65B9\u300C\u5F00\u59CB\u540C\u6B65\u300D",
  ...
  "syncTab.status.remoteKind.hint": "\u8FD9\u662F\u8BB0\u5FC6\u5B9E\u9645\u5B58\u653E\u548C\u5BF9\u8D26\u7684\u4F4D\u7F6E\uFF0C\u53EF\u5728\u4E0B\u65B9\u5207\u6362\uFF08\u672C\u5730\u8BB0\u5FC6\u5B8C\u6574\u4FDD\u7559\u3001\u65E7\u5206\u652F\u7559\u6863\uFF09\u3002",
  "syncTab.status.branch": "\u8FDC\u7AEF\u5206\u652F\uFF1A{branch}",
  "syncTab.status.counts": "\u672A\u63D0\u4EA4 {uncommitted} \u6761 \xB7 \u843D\u540E\u8FDC\u7AEF {behind} \u4E2A\u63D0\u4EA4 \xB7 \u51B2\u7A81 {conflicts} \u6761",
  "syncTab.status.migrate": "\u53D1\u73B0\u65E7\u8BB0\u5FC6\u76EE\u5F55\uFF1A{dir}\u2014\u2014\u70B9\u300C\u5F00\u59CB\u540C\u6B65\u300D\u4F1A\u81EA\u52A8\u8FC1\u79FB",
  "syncTab.global.title": "\u5168\u5C40\u8BB0\u5FC6",
  "syncTab.global.notInit": "\u5168\u5C40\u8BB0\u5FC6\u540C\u6B65\u9700\u8981\u5171\u4EAB\u8BB0\u5FC6\u4ED3\u5E93\u2014\u2014\u5728\u4E0B\u65B9\u300C\u8BB0\u5FC6\u8FDC\u7AEF\u4E0E\u540C\u6B65\u300D\u586B\u4ED3\u5E93\u5730\u5740\u540E\u53EF\u7528",
  "syncTab.global.uncommitted": "\u672A\u63D0\u4EA4 {n} \u6761",
  ...
  "syncTab.global.hint": "\u5168\u5C40\u8BB0\u5FC6\uFF08\u7528\u6237\u6863\u6848/\u6BCF\u65E5\u65E5\u5FD7/\u5F85\u529E\uFF09\u4E0D\u5C5E\u4E8E\u4EFB\u4F55\u9879\u76EE\uFF0C\u53EA\u6709\u5171\u4EAB\u8BB0\u5FC6\u4ED3\u5E93\u80FD\u653E\u2014\u2014\u6BCF\u8F68\u72EC\u7ACB\u5F00\u5173\uFF0C\u5F00\u54EA\u4E2A\u540C\u6B65\u54EA\u4E2A\uFF1B\u63A8\u9001\u6C38\u8FDC\u9700\u4F60\u663E\u5F0F\u70B9\u51FB",
  "syncTab.actions.title": "\u64CD\u4F5C",
  "syncTab.remote.title": "\u8BB0\u5FC6\u653E\u54EA\uFF1F\u600E\u4E48\u9009",
  "syncTab.remote.default.title": "\u4E0D\u586B\u5730\u5740\uFF08\u9ED8\u8BA4\uFF0C\u6700\u7B80\u5355\uFF09",
  "syncTab.remote.default.desc": "\u8BB0\u5FC6\u653E\u8FDB\u4F60\u7684\u4EE3\u7801\u4ED3\u5E93\uFF08\u4E13\u5C5E\u5206\u652F\uFF0C\u4E0D\u6C61\u67D3\u4EE3\u7801\uFF09\u3002\u96F6\u914D\u7F6E\u3002**\u6CE8\u610F\uFF1A\u4EE3\u7801\u4ED3\u5E93\u516C\u5F00 = \u8BB0\u5FC6\u4E5F\u516C\u5F00**\u2014\u2014\u4ECB\u610F\u5C31\u7528\u4E0B\u9762\u7684\u5171\u4EAB\u8BB0\u5FC6\u4ED3\u5E93",
  "syncTab.remote.shared.title": "\u586B\u4E00\u4E2A\u5171\u4EAB\u8BB0\u5FC6\u4ED3\u5E93\u5730\u5740",
  "syncTab.remote.shared.desc": "\u4E00\u4E2A\u4E13\u95E8\u653E\u8BB0\u5FC6\u7684\u79C1\u6709\u4ED3\u5E93\uFF0C\u6240\u6709\u9879\u76EE\u5171\u7528\uFF08\u6BCF\u4E2A\u9879\u76EE\u81EA\u52A8\u4E00\u6761\u4E13\u5C5E\u5206\u652F\uFF09\uFF0C\u8BB0\u5FC6\u4E0E\u4EE3\u7801\u5F7B\u5E95\u9694\u79BB\uFF1B\u5168\u5C40\u8BB0\u5FC6\uFF08\u7528\u6237\u6863\u6848/\u6BCF\u65E5\u65E5\u5FD7/\u5F85\u529E\u7B49\uFF09\u4E5F\u53EA\u6709\u7528\u5B83\u624D\u80FD\u8DE8\u8BBE\u5907\u540C\u6B65",
  "syncTab.remote.mode.title": "\u8BB0\u5FC6\u8FDC\u7AEF\uFF08\u8BB0\u5FC6\u5B58\u653E\u4E0E\u5BF9\u8D26\u7684\u4F4D\u7F6E\uFF09",
  "syncTab.remote.modeMain": "\u4E3B\u4EE3\u7801\u4ED3\u5E93\uFF08\u9ED8\u8BA4\uFF0C\u96F6\u914D\u7F6E\uFF09",
  "syncTab.remote.modeMain.desc": "\u8BB0\u5FC6\u653E\u8FDB\u4F60\u7684\u4EE3\u7801\u4ED3\u5E93\u7684\u4E13\u5C5E\u5206\u652F\uFF08\u4E0D\u6C61\u67D3\u4EE3\u7801\uFF09\u3002**\u4EE3\u7801\u4ED3\u5E93\u516C\u5F00 = \u8BB0\u5FC6\u4E5F\u516C\u5F00**",
  "syncTab.remote.modeShared": "\u5171\u4EAB\u8BB0\u5FC6\u4ED3\u5E93",
  "syncTab.remote.modeShared.desc": "\u4E00\u4E2A\u4E13\u95E8\u653E\u8BB0\u5FC6\u7684\u79C1\u6709\u4ED3\u5E93\uFF0C\u6240\u6709\u9879\u76EE\u5171\u7528\uFF08\u6BCF\u9879\u76EE\u4E00\u6761\u4E13\u5C5E\u5206\u652F\uFF09\uFF0C\u8BB0\u5FC6\u4E0E\u4EE3\u7801\u5F7B\u5E95\u9694\u79BB\uFF1B\u5168\u5C40\u8BB0\u5FC6\u4E5F\u53EA\u6709\u7528\u5B83\u624D\u80FD\u540C\u6B65",
  "syncTab.remote.placeholder": "\u7C98\u8D34\u5171\u4EAB\u8BB0\u5FC6\u4ED3\u5E93\u5730\u5740",
  "syncTab.remote.applyMain": "\u5207\u5230\u4E3B\u4EE3\u7801\u4ED3\u5E93",
  "syncTab.remote.applyShared": "\u5207\u5230\u5171\u4EAB\u8BB0\u5FC6\u4ED3\u5E93",
  "syncTab.remote.currentMain": "\u5F53\u524D\uFF1A\u4E3B\u4EE3\u7801\u4ED3\u5E93",
  "syncTab.remote.currentShared": "\u5F53\u524D\uFF1A\u5171\u4EAB\u8BB0\u5FC6\u4ED3\u5E93",
  "syncTab.remote.switchHint": "\u5207\u6362\u53EA\u6539\u8BB0\u5FC6\u5B58\u653E\u4F4D\u7F6E\uFF1A\u672C\u5730\u8BB0\u5FC6\u5B8C\u6574\u4FDD\u7559\u3001\u65E7\u5206\u652F\u7559\u6863\uFF0C\u5207\u6362\u540E\u70B9\u4E00\u6B21\u300C\u540C\u6B65\u300D\u5B8C\u6210\u5BF9\u8D26",
  "syncTab.remote.needUrl": "\u5148\u7C98\u8D34\u5171\u4EAB\u8BB0\u5FC6\u4ED3\u5E93\u5730\u5740",
  "syncTab.actions.setupDefault": "\u5F00\u59CB\u540C\u6B65\uFF08\u7528\u4EE3\u7801\u4ED3\u5E93\uFF09",
  "syncTab.actions.setupShared": "\u7528\u8FD9\u4E2A\u4ED3\u5E93\u540C\u6B65",
  "syncTab.actions.sync": "\u540C\u6B65\uFF08\u62C9\u53D6\u5E76\u5408\u5E76\uFF09",
  "syncTab.actions.push": "\u540C\u6B65\u5E76\u63A8\u9001\uFF08\u9700\u4F60\u663E\u5F0F\u70B9\u51FB\uFF09",
  "syncTab.actions.nothingToSync": "\u6CA1\u6709\u53EF\u540C\u6B65\u7684\u5185\u5BB9\u2014\u2014\u5148\u6253\u5F00\u300C\u672C\u9879\u76EE\u540C\u6B65\u300D\u6216\u4E0B\u65B9\u5168\u5C40\u8F68\u5F00\u5173",
...
var en = {
  ...
  "syncTab.projectEnabled.hint": "Project-level switch (off by default): turning it on syncs all project memory (KEY + project log + archive + project todos) and starts reconciling \u2014 the memory remote defaults to your code repo (zero config), or you can switch to a shared memory repo below. Turning it off disables this project (memory stays local, re-enable anytime). **Projects never opted in keep the exact pre-module local state** (no Git repo, no entry IDs)",
  "syncTab.section.project": "This project",
  "syncTab.section.global": "Global memory (not project-specific)",
  "syncTab.section.sync": "Memory remote & sync",
  "syncTab.status.title": "Current memory remote",
  "syncTab.status.disabled": 'Disabled \u2014 turn on "Sync this project" above to begin',
  "syncTab.status.notInit": 'Enabled, but this project is not initialized yet \u2014 click "Start sync" below',
  ...
  "syncTab.status.remoteKind.hint": "This is where memory is actually stored and reconciled. You can switch it below (local memory stays intact, old branch stays archived).",
  "syncTab.status.branch": "Remote branch: {branch}",
  "syncTab.status.counts": "{uncommitted} uncommitted \xB7 {behind} behind \xB7 {conflicts} conflicts",
  "syncTab.status.migrate": 'Legacy memory dir found: {dir} \u2014 "Start sync" will migrate it',
  "syncTab.global.title": "Global memory",
  "syncTab.global.notInit": 'Global memory sync needs a shared memory repo \u2014 paste its URL under "Memory remote & sync" below',
  "syncTab.global.uncommitted": "{n} uncommitted",
  ...
  "syncTab.global.hint": "Global memory (user profile / daily logs / todos) belongs to no single project \u2014 only a shared memory repo can hold it. Each track has its own switch; push always requires your explicit click",
  "syncTab.actions.title": "Actions",
  "syncTab.remote.title": "Where does memory live?",
  "syncTab.remote.default.title": "Leave the URL empty (default, simplest)",
  "syncTab.remote.default.desc": "Memory lives in your code repo (dedicated branch, never touches your code). Zero config. **Note: a public code repo means public memory** \u2014 use a shared memory repo below if that matters",
  "syncTab.remote.shared.title": "Paste a shared memory repo URL",
  "syncTab.remote.shared.desc": "One private repo dedicated to memory, shared by all projects (each project automatically gets its own branch), fully isolated from your code; global memory (user profile / daily logs / todos) can only sync through it",
  "syncTab.remote.mode.title": "Memory remote (where memory lives and reconciles)",
  "syncTab.remote.modeMain": "Main code repo (default, zero config)",
  "syncTab.remote.modeMain.desc": "Memory lives in a dedicated branch of your code repo (never touches your code). **A public code repo means public memory**",
  "syncTab.remote.modeShared": "Shared memory repo",
  "syncTab.remote.modeShared.desc": "One private repo dedicated to memory, shared by all projects (one branch per project), fully isolated from your code; global memory can only sync through it",
  "syncTab.remote.placeholder": "Paste a shared memory repo URL",
  "syncTab.remote.applyMain": "Switch to main code repo",
  "syncTab.remote.applyShared": "Switch to shared memory repo",
  "syncTab.remote.currentMain": "Current: main code repo",
  "syncTab.remote.currentShared": "Current: shared memory repo",
  "syncTab.remote.switchHint": 'Switching only changes where memory lives: local memory stays intact and the old branch stays archived; run "Sync" once after switching to reconcile',
  "syncTab.remote.needUrl": "Paste a shared memory repo URL first",
  "syncTab.actions.setupDefault": "Start sync (use code repo)",
  "syncTab.actions.setupShared": "Sync with this repo",
  "syncTab.actions.sync": "Sync (fetch & merge)",
  "syncTab.actions.push": "Sync & push (explicit click = consent)",
  "syncTab.actions.nothingToSync": 'Nothing to sync \u2014 enable "Sync this project" or a global track below first',
