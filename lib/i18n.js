...
export const PROMPT_DICT = {
  'promptmsg.targetSessionRequired': ['请先打开目标会话，再注入提示词', 'Open the target session before injecting a prompt'],
...
export const COI_DICT = {
  'coi.noAccessibleRecentSession': ['当前会话没有可继续的已登记 COI 会话，请先发起任务或指定有权访问的会话 ID', 'No accessible COI session is registered for this session. Start a task first or specify a session ID you can access'],
...
export const COI2_DICT = {
  'coi2.taskInaccessible': ['任务 {id} 不存在或当前会话无权访问', 'Task {id} does not exist or is not accessible from this session'],
  'coi2.sessionInaccessible': ['会话 {id} 不存在或当前会话无权访问', 'Session {id} does not exist or is not accessible from this session'],
